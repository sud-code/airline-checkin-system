...
CREATE TABLE check_ins (
    ...
    UNIQUE (flight_id, seat_id) -- Ensures one seat per flight is assigned to only one check-in
);
...
BEGIN
    FOR row_num IN 1..25 LOOP
        FOR col_num IN 1..4 LOOP
            ...
            -- Insert seat
            INSERT INTO seats (aircraft_id, seat_number, seat_class, seat_type)
            VALUES (1, row_num || row_letter, seat_class, seat_type);
        END LOOP;
    END LOOP;
END $$;
